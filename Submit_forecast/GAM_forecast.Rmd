...
if.require(install.packages("tidymodels"))
if.require(install.packages("mgcv"))
if.require(install.packages("reshape2"))
if.require(install.packages("lubridate"))
# Load packages
library(tidyverse)
library(lubridate)
library(tidymodels)
...
noaa_date <- forecast_date - days(3)
