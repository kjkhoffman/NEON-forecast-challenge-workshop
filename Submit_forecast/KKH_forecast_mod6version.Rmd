---
title: "KKH_forecast_mod6version"
author: "KKH"
date: "2024-02-15"
...
```{r}
met_variables <- c("air_temperature", "precipitation_flux")
...
```{r}
my_model_id <- 'example_ID_airtempANDprecipadjusted_wuncertainty'
```
